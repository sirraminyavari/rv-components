...
export interface RVAvatarGroup
  extends PropsWithoutRef<DetailedHTMLProps<HTMLAttributes<HTMLImageElement>, HTMLImageElement>> {}

const AvatarGroup = forwardRef<HTMLImageElement, RVAvatarGroup>(
  ({ children, className, ...props }, ref) => {
    return (
      <div ref={ref} className={clsx(styles.baseAvatarGroup, className)} {...props}>
        {children}
      </div>
    );
  }
